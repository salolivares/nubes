...
import type { IpcRequest, IpcResponse } from '../../../../types/api';
import { ipcMain } from 'electron';
import { appRouter, TRPC_CHANNEL } from '@common';

async function ipcRequestHandler<TRouter extends AnyRouter>(opts: {
  req: IpcRequest;
  router: TRouter;
...
export function addTRPCListenters() {
  ipcMain.handle(TRPC_CHANNEL, (_, req: IpcRequest) => {
